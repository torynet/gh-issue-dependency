...
**FIRST ACTION**: Log start: `echo "$(date '+%Y-%m-%d %H:%M:%S') - code-analyzer: [brief task description]" >> ${DEV}claude-agent.log`
...
- Format: `- [ ] [timestamp] code-analyzer: Problem description`
